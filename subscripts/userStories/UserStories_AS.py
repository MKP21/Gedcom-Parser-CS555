            ...
            if families['HUSB'] == individuals['INDI']:
             ...
             # checking for wifi id is equal to individual id
                ...
                if n!= 'NA':
                    #checking for marriage date greater than the individual's death date
                    if families['MARR'] > n:
                        f.write(f"ERROR: INDIVIDUAL : US05 : : {individuals['INDI']} : Married {families['MARR']} after wifi's ({individuals['INDI']}) death on {individuals['DEAT']} ")
        ...
        for individuals in indi:
            ...
            if families['HUSB'] == individuals['INDI']:
                ...
                if m != 'NA' and families['DIV'] !='NA':
                    ...
                    if m < families['DIV']:
                        f.write(f"ERROR: FAMILY : US06 : : {individuals['INDI']} : Divorced {families['DIV']} after husband's ({individuals['INDI']}) death on {individuals['DEAT']} ")
            ...
            if families['WIFE'] == individuals['INDI']:
                ...
                if n!= 'NA' and families['DIV'] !='NA':
                    ...
                    if n < families['DIV']:
                        f.write(f"ERROR: FAMILY : US06 : : {individuals['INDI']} : Divorced {families['DIV']} after wifi's ({individuals['INDI']}) death on {individuals['DEAT']} ")
